      ...
      <div className="footer-main" data-aos="fade-up">
        ...
        <div className="footer-links-wrap">
          ...
          <div className="footer-col footer-contact">
            ...
            <a href="https://www.google.com/maps?ll=19.166667,72.83614&z=16&t=m&hl=en&gl=IN&mapclient=embed" target="_blank" className="footer-contact-item">
            ...
            <a href="mailto:drmanojgaddikeri@gmail.com" className="footer-contact-item" target="_blank">
              <span><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="tel:+91 9986631541" className="footer-contact-item" target="_blank">
              <span><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
